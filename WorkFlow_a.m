...
xa=linspace(0,2.5,20);
xb=linspace(0,2.5,20);
...
function dx = sigmoidal(t,x) % 8 parameters 
    ...
    dx1=-x1./param(1)+param(2)./(1+exp(x1+param(3)))+param(4)./(1+exp(x2+param(5)))+xI;
    dx2=-x2./param(6)+param(7)./(1+exp(x1+param(3)))+param(8)./(1+exp(x2+param(5)))+xI;
